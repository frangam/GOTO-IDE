...
/**
 * 	Source: https://github.com/jfacorro/clojure-lab/blob/master/src/java/lab/ui/swing/LineHighlighter.java
...
public class LineHighlighter implements Highlighter.HighlightPainter, CaretListener, MouseListener, MouseMotionListener {
	...
	{
		int red   = Math.min(255, (int)(color.getRed() * 0.4));
		int green = Math.min(255, (int)(color.getGreen() * 0.4));
		int blue  = Math.min(255, (int)(color.getBlue() * 0.4));
